...
import simplechess.main.Board;
import simplechess.main.GamePanel;
import simplechess.main.Type;
...
public class Piece {
    ...
    public BufferedImage getImage(String imagePath) {
        ...
        try {
             var is = getClass().getResourceAsStream(imagePath + ".png");
        if (is == null) {
            System.out.println("failes image load: " + imagePath + ".png");
            return null;
        }
